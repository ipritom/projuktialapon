...
if(isset($_POST['submit_article'])){
    ...
    if(isset($_SESSION['id'])){
        ...
        $sql1 = "insert into posts(post_id,user_id,title,date,content) values(NULL,'$uid','$text1',CURDATE(),'$text2');";
        ...
        // if everything is ok, try to upload file
            ...
            if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
                $sql = "insert into picture(pic_id,post_id,user_id,caption,pic) values(null,$postID,$uid,'$text3','$img_name');";
